...
set(Qt5Scxml_VERSION_STRING 5.12.2)
...
if (NOT TARGET Qt5::Scxml)
    ...
    set(Qt5Scxml_PRIVATE_INCLUDE_DIRS
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.12.2"
        "${_qt5Scxml_install_prefix}/include/QtScxml/5.12.2/QtScxml"
    )
    ...
    set(_Qt5Scxml_MODULE_DEPENDENCIES "Core")
    ...
    foreach(_module_dep ${_Qt5Scxml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.2 ${_Qt5Scxml_FIND_VERSION_EXACT}
    ...
    set(_Qt5Scxml_LIB_DEPENDENCIES "Qt5::Core")
