...
JSC::JSValue toJS(JSC::ExecState*, JSDOMGlobalObject*, SVGUnitTypes*);
SVGUnitTypes* toSVGUnitTypes(JSC::JSValue);

class JSSVGUnitTypesPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSSVGUnitTypesPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
