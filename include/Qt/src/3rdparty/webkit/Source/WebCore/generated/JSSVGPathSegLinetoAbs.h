...
class JSSVGPathSegLinetoAbsPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSSVGPathSegLinetoAbsPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
