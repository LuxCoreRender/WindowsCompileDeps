...
class JSSVGFontFaceFormatElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSSVGFontFaceFormatElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
