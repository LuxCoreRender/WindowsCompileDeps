...
class JSUint32ArrayPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSUint32ArrayPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
...
public:
    JSUint32ArrayConstructor(JSC::ExecState*, JSC::Structure*, JSDOMGlobalObject*);
