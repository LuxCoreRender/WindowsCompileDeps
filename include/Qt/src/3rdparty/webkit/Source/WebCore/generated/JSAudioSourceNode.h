...
public:
    JSAudioSourceNode(JSC::Structure*, JSDOMGlobalObject*, PassRefPtr<AudioSourceNode>);
...
public:
    ...
    JSAudioSourceNodePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
