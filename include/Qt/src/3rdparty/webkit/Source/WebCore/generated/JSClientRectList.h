...
class JSClientRectListPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSClientRectListPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
