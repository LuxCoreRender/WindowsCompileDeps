...
class JSHTMLDetailsElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLDetailsElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
