...
class JSHTMLLabelElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLLabelElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
...
JSC::JSValue jsHTMLLabelElementControl(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
