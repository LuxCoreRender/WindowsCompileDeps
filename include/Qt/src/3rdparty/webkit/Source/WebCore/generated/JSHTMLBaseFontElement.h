...
class JSHTMLBaseFontElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLBaseFontElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
