...
class JSHTMLBRElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLBRElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
