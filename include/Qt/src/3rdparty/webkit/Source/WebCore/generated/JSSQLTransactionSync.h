...
class JSSQLTransactionSyncPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSSQLTransactionSyncPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
