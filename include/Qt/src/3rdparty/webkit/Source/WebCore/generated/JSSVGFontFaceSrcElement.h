...
class JSSVGFontFaceSrcElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSSVGFontFaceSrcElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
