...
public:
    ...
    ArrayBufferView* impl() const { return m_impl.get(); }

private:
    RefPtr<ArrayBufferView> m_impl;
protected:
...
class JSArrayBufferViewPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSArrayBufferViewPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
