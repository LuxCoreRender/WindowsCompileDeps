...
class JSHTMLModElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLModElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
