...
class JSHTMLDataListElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLDataListElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
