...
class JSHTMLParagraphElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLParagraphElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
