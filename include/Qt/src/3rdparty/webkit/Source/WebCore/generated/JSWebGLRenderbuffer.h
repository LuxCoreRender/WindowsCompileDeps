...
class JSWebGLRenderbufferPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSWebGLRenderbufferPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
...
JSC::JSValue jsWebGLRenderbufferConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
