...
class JSGeopositionPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSGeopositionPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
