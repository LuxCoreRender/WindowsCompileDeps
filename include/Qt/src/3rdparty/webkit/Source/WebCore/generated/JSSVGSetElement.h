...
class JSSVGSetElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSSVGSetElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
