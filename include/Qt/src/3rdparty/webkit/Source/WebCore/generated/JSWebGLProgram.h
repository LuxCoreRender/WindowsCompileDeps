...
class JSWebGLProgramPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSWebGLProgramPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
...
JSC::JSValue jsWebGLProgramConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
