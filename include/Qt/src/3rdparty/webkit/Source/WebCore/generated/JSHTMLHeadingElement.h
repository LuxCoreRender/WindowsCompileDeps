...
class JSHTMLHeadingElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLHeadingElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
