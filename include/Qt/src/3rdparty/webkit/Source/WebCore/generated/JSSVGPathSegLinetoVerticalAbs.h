...
class JSSVGPathSegLinetoVerticalAbsPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSSVGPathSegLinetoVerticalAbsPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
