...
class JSCSSPageRulePrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSCSSPageRulePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) : JSC::JSObjectWithGlobalObject(globalData, globalObject, structure) { }
protected:
